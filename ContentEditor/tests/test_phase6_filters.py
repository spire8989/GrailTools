...
class Phase6FilterBrowserTests(unittest.TestCase):
    ...
    def test_item_filters_stack_search_and_update_from_unsaved_draft(self) -> None:
        ...
        self.set_single("equipmentSlot", "shield")
        self.assertEqual(self.count(), (self.item_count(lambda item: item.get("equipmentSlot") == "shield"), item_total))
        self.set_single("category", "shield")
        self.assertEqual(self.count(), (self.item_count(lambda item: item.get("category") == "shield"), item_total))
        self.set_single("equipmentSlot", "")
        self.set_single("category", "")
